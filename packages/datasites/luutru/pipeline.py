"""Registry + dispatch for the five luutru curation pipelines.
...
:mod:`packages.datasites.luutru._shared` so tests / notebooks can
...
from packages.datasites.luutru.download import build_download_pipeline
from packages.datasites.luutru.embed import build_embed_pipeline
from packages.datasites.luutru.extract import build_extract_pipeline
from packages.datasites.luutru.parse import build_parse_pipeline
from packages.datasites.luutru.reduce import build_reduce_pipeline
